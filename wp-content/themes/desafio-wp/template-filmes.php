...
<section>
    <div class="container-fluid categorias">
        <div class="row">
            <!-- Left Column -->
            <div class="col-md-6">
                <h1 class="text-series">Filmes</h1>
        ...
        $args = array(
            ...
            'tax_query' => array(
                array(
                    ...
                    'field' => 'slug',
                    'terms' => 'filmes', // Slug of the "series" category
                ),
            ),
        );
        ...
        if ($custom_query->have_posts()) :
            while ($custom_query->have_posts()) :
                ...
                <?php
                            ...
                            echo '<p style="color:white;font-family: Circular Spotify Tx T, sans-serif;">No video posts in the "filmes" category found.</p>';
                        endif;
                        ?>
